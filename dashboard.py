...
class Dashboard(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self._QLabelimageSortieRoute = str(pictures_folder / "sortie_route.png")
...
########## Positionnement des boutons:
        ...
        ############
        scaledpixmapSortieRoute = QtGui.QPixmap(self._QLabelimageSortieRoute).scaled(self._image_size,
                                                                                                 QtCore.Qt.KeepAspectRatio,
                                                                                                 QtCore.Qt.SmoothTransformation)

        self.buttonSortieRoute = QPushButton()
        self.buttonSortieRoute.setIcon(QtGui.QIcon(scaledpixmapSortieRoute))
        self.buttonSortieRoute.setIconSize(self._image_size)
        self.buttonSortieRoute.setObjectName("SortieRoute")
        self.buttonSortieRoute.mousePressEvent = functools.partial(self._on_click,
                                                                     name=self.buttonSortieRoute.objectName())
        layout.addWidget(self.buttonSortieRoute, 2, 3)
